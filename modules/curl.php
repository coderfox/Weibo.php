    ...
    private function parseResponse($response){
        ...
        if (! (strpos( $response, "\r\n\r\n" ) === false)) {
            ...
            if (isset( $response_headers ['Content-Type'] )) {
                ...
                } elseif (preg_match( '/^application\/atom\+xml/i', $response_headers ['Content-Type'] ) || preg_match( '/^application\/rss\+xml/i', $response_headers ['Content-Type'] ) || preg_match( '/^application\/xml/i', $response_headers ['Content-Type'] ) || preg_match( '/^text\/xml/i', $response_headers ['Content-Type'] )) {
